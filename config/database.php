    ...
    */
    ...
    'connections' => [
        ...
        'pms' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_PMS_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('DB_PMS_PORT', env('DB_PORT', '3306')),
            'database' => env('DB_PMS_DATABASE', 'pms'),
            'username' => env('DB_PMS_USERNAME', env('DB_USERNAME', 'root')),
            'password' => env('DB_PMS_PASSWORD', env('DB_PASSWORD', '')),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
