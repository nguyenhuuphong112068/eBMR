...
class RoomLogbookSeeder extends Seeder
{
    /**
    ...
    {
        \App\Models\RoomLogbook::truncate();

        $now = now();
        
        \App\Models\RoomLogbook::insert([
            [
                'room_id' => 1,
            ...
            [
                ...
                'remarks' => 'Vệ sinh chuyển đổi sản phẩm',
                'created_by' => 2,
