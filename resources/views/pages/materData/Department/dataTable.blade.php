    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header border-0 bg-transparent pt-4 pb-0 px-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                <h3 class="card-title fw-bold text-dark">Danh sách Phòng Ban</h3>
        ...
        <div class="card-body">
            <table id="data_table_department" class="table table-hover w-100">
                <thead>
                    <tr>
                        <th>STT</th>
                        <th>Tên Viết Tắt</th>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            if ($.fn.DataTable.isDataTable('#data_table_department')) {
                $('#data_table_department').DataTable().destroy();
            }

            const table = $('#data_table_department').DataTable({
                paging: true,
                lengthChange: true,
                searching: true,
                ordering: true,
