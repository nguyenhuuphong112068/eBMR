    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header border-0 bg-transparent pt-4 pb-0 px-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                <h3 class="card-title fw-bold text-dark">Danh sách Chức Vụ</h3>
        ...
        <div class="card-body">
            <table id="data_table_designation" class="table table-hover w-100">
                <thead>
                    <tr>
                        <th>STT</th>
                        <th>Tên Viết Tắt</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <div class="d-flex gap-1 justify-content-center">
                                    ...
                                    <form class="form-deActive d-inline" action="{{ route('pages.materData.designation.deActive') }}" method="POST">
                                        @csrf
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            if ($.fn.DataTable.isDataTable('#data_table_designation')) {
                $('#data_table_designation').DataTable().destroy();
            }

            const table = $('#data_table_designation').DataTable({
                paging: true,
                lengthChange: true,
                searching: true,
                ordering: true,
            ...
            $('.form-deActive').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    text: `Bạn có chắc chắn muốn ${actionText} chức vụ: ${name}?`,
                    icon: 'warning',
