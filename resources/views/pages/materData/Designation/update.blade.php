    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Cập Nhật Thông Tin Chức Vụ</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('pages.materData.designation.update') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="update_name">Tên Chức Vụ <span class="text-danger">*</span></label>
