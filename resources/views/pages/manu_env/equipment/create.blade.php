<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('pages.manu_env.equipment.store') }}" method="POST">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="operation_SOP_code" value="{{ old('operation_SOP_code') }}" placeholder="Ví dụ: SOP-VH-01">
                                @error('operation_SOP_code', 'createErrors')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mb-3">
                                <label class="fw-bold small text-uppercase text-muted mb-2">SOP Vệ Sinh</label>
                                <input type="text" class="form-control" name="clearing_SOP_code" value="{{ old('clearing_SOP_code') }}" placeholder="Ví dụ: SOP-VS-01">
                                @error('clearing_SOP_code', 'createErrors')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mb-3">
                                <div class="custom-control custom-checkbox mt-2">
                                    <input type="checkbox" class="custom-control-input" id="create_is_Portable_equipment" name="is_Portable_equipment" value="1">
                                    <label class="custom-control-label fw-bold text-dark small" for="create_is_Portable_equipment">Thiết bị di động (Portable)</label>
                                </div>
                            </div>
                        </div>
