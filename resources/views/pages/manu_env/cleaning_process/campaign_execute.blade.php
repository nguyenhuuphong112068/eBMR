...
@section('mainContent')
    ...
    @section('script')
        <script>
            ...
            const CAMPAIGN_STATUS_EDITABLE = CAMPAIGN_STATUS !== 'completed';
            const EDIT_STEP_URL_BASE = "{{ url('/manu_env/cleaning-process/campaign') }}";
            const STEP_HISTORY_URL_BASE = "{{ url('/manu_env/cleaning-process/campaign/step') }}";
            ...
            // Dùng khi thao tác nhầm (vd lỡ bấm "Không đạt" trong khi thực tế "Đạt")
            // — bắt buộc nhập lý do, luôn ghi lịch sử trước/sau ở server.
