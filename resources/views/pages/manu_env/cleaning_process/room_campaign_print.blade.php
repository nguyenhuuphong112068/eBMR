...
<head>
    <meta charset="UTF-8">
    <title>Báo Cáo Vệ Sinh Phòng - {{ $room->code }}</title>
...
<body onload="window.print()">
    <div class="text-center">
        <div class="title fw-bold">BÁO CÁO VỆ SINH PHÒNG</div>
        <div class="subtitle">Mã phòng: {{ $room->code }} - Tên phòng: {{ $room->name }}</div>
    </div>
