    ...
    <div class="row justify-content-center">
        ...
        <div id="outline-col" class="col-lg-2 transition-all">
            <div class="p-3 bg-white rounded shadow-sm outline-sidebar h-100">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="mb-0 text-muted fw-bold" style="font-size: 0.85rem;"><i class="fas fa-list-ul me-2"></i>MỤC LỤC & THẺ</h6>
                    <button class="btn btn-sm btn-light text-muted border-0" onclick="toggleOutline(true)" title="Thu nhỏ"><i class="fas fa-chevron-left"></i></button>
                </div>
            ...
            <!-- Minimized ToC -->
            <div id="outline-minimized" class="d-none bg-white rounded-end shadow-sm py-3 text-center cursor-pointer transition-all" onclick="toggleOutline(false)" 
                ...
                <div style="writing-mode: vertical-rl; transform: rotate(180deg); font-size: 0.75rem; font-weight: bold; color: #6c757d; white-space: nowrap; flex-grow: 1; display: flex; align-items: center; justify-content: center;">MỤC LỤC & THẺ</div>
        ...
        <div id="canvas-col" class="col-lg-9 transition-all">
            ...
            <div id="designer-workspace" class="d-flex justify-content-start align-items-start" style="width: 100%; margin: 0; padding-right: 20px;">
                ...
                <div id="comment-gutter" class="comment-gutter ms-4 d-none" style="position: relative; flex-grow: 1; min-width: 300px; height: 100%;">
