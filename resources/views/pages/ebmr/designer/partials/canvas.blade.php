...
<!-- ============================================================
     ...
     ============================================================ -->
<div class="modal fade" id="scaleConnectionModal" tabindex="-1" aria-labelledby="scaleConnectionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">

            <!-- Header -->
            <div class="modal-header py-3 px-4" style="background: linear-gradient(135deg, #14532d, #16a34a); color: white; border: none;">
                ...
                <button type="button" class="btn-close btn-close-white ms-auto" data-bs-dismiss="modal" data-dismiss="modal" aria-label="Đóng"></button>
            </div>
            ...
            <div class="modal-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-lg-6">
                        ...
                        <!-- Trạng thái kết nối -->
                        <div class="d-flex align-items-center gap-2 mb-3 p-3 rounded-3" style="background: #f8fafc; border: 1px solid #e2e8f0;">
                        ...
                        <div id="scale-custom-fields" class="d-none mb-3 p-3 rounded-3" style="background: #fffbeb; border: 1px solid #fde68a;">
                        ...
                        <!-- Ghi chú trình duyệt -->
                        <div class="alert alert-info py-2 px-3 small mb-0" style="font-size: 0.78rem; border-left: 3px solid #0ea5e9; background: #f0f9ff; border-color: #bae6fd;">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="text-center mb-3 p-3 rounded-3" style="background: #f0fdf4; border: 2px solid #bbf7d0;">
                            <div class="small text-muted mb-1 fw-bold text-uppercase" style="font-size: 0.7rem; letter-spacing: 0.08em;">
                                <i class="fas fa-satellite-dish me-1"></i> Dữ liệu cân (Live)
                            </div>
                            <span id="scale-live-value" class="scale-live-value stable" style="color: #9ca3af;">
                                —.— g
                            </span>
                            <div class="small text-muted" style="font-size: 0.72rem;">
                                Xanh = Ổn định ✓ &nbsp;|&nbsp; Vàng = Đang rung động
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <div id="scale-raw-log">
                                <div style="color: #475569; font-size: 0.72rem; font-style: italic; padding: 2px 0;">
            ...
            <div class="modal-footer px-4 py-3" style="background: #f8fafc; border-top: 1px solid #e2e8f0;">
                <div class="d-flex justify-content-between align-items-center w-100">
                    ...
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-outline-secondary btn-sm" data-bs-dismiss="modal" data-dismiss="modal">
                            Đóng
                        </button>
                        <button type="button" class="btn btn-success btn-sm px-4 fw-bold"
                                onclick="window.readScaleFromModal()"
                                id="scale-read-now-btn">
