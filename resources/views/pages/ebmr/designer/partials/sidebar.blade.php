...
<div id="property-panel" class="bg-transparent shadow-none border-0" style="border-radius: 12px; box-shadow: none;">
    <div id="sidebar-full" class="d-none">
        <div class="card-header bg-light border-0 py-3 d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-sm btn-light text-muted border-0" onclick="toggleSidebar(true)" title="Thu nhỏ"><i
    ...
    <div id="sidebar-minimized" class="bg-white rounded-start shadow-sm py-3 text-center cursor-pointer transition-all"
        ...
        <div
            style="writing-mode: vertical-rl; transform: rotate(180deg); font-size: 0.75rem; font-weight: bold; color: #6c757d; white-space: nowrap; flex-grow: 1; display: flex; align-items: center; justify-content: center; letter-spacing: 1px;">
            CÀI ĐẶT</div>
    </div>
</div>
