                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="card-header bg-primary py-3 d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 text-white fw-bold"><i class="fas fa-file-export me-2"></i> Hồ Sơ Hiện Hành & Ban
                                Hành Lô</h5>
                        ...
                        <div class="card-body p-4">
                            <div class="alert alert-info border-0 shadow-none d-flex align-items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">Danh sách dưới đây là các hồ sơ đã được phê duyệt và ban hành
                                        chính thức. Người phụ trách sản xuất chọn hồ sơ và nhập số lô để bắt đầu quá trình
                                        ghi chép dữ liệu.</p>
                                </div>
                            </div>
