...
@section('title', 'Danh sách Sổ Nhật Ký Thiết Bị')
...
<div class="content-wrapper">
    <div class="container-fluid py-4">
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h3 class="mb-0 text-navy fw-bold">DANH SÁCH SỔ NHẬT KÝ THIẾT BỊ</h3>
                <p class="text-muted mb-0 small">Chọn một thiết bị để xem sổ nhật ký của thiết bị đó</p>
            </div>
        </div>
        ...
        <div class="row">
            @forelse($instruments as $instrument)
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                    <a href="{{ route('pages.ebmr.logbooks.instrument.show', ['instrument_id' => $instrument->id]) }}" class="text-decoration-none">
                        <div class="card h-100 border-0 shadow-sm rounded-4 notebook-card position-relative overflow-hidden">
                            <div class="notebook-binding"></div>
                            <div class="notebook-stitch"></div>
                            <i class="fas fa-microscope watermark-icon"></i>
                            <div class="pharma-badge">GMP</div>
                            <div class="card-body p-4 text-center d-flex flex-column justify-content-center align-items-center card-body-content">
                                <div class="mb-3">
                                    <i class="fas fa-microscope fa-3x text-navy opacity-75"></i>
                                </div>
                                <h5 class="fw-bold text-navy mb-1">{{ $instrument->code }}</h5>
                                <p class="text-muted small mb-0">{{ $instrument->name ?? 'Thiết bị ' . $instrument->code }}</p>
                            </div>
                            <div class="card-footer border-0 text-center py-2 notebook-footer">
                                <span class="small text-primary fw-bold">Mở sổ <i class="fas fa-arrow-right ms-1"></i></span>
                            </div>
                        </div>
                    </a>
                </div>
            @empty
                <div class="col-12 text-center py-5">
                    ...
                    <h5 class="text-muted">Không có thiết bị nào trong phân xưởng này.</h5>
                </div>
            @endforelse
        </div>
    </div>
