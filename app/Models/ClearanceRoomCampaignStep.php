...
class ClearanceRoomCampaignStep extends Model
{
    use HasFactory;

    protected $table = 'clearance_room_campaign_steps';
    ...
    {
        return $this->belongsTo(ClearanceRoomCampaign::class, 'campaign_id', 'id');
    }
